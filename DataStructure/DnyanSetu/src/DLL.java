...
public class DLL {
	...
	public void insertStart(Employee data) {
...
//			return;
	...
	public void insertPosition(Employee data, int pos) {
		Node temp1 = new Node(data);
		if(isEmpty()) {
			start = last = temp1;
			size++;
	...
	public void display() {
		...
		if(isEmpty()) {
			...
			while(temp != null) {
				...
				System.out.printf("%-10d %-15s %-10d %-15s%n",e.getId(), e.getName(), e.getSalary(), e.getDept());
				temp = temp.getNext();
			}
		}
	}
