...
class FarmMain {
    public static void main(String[] args) {
        DairyFarmer df = new DairyFarmer(101, "Ramesh", 10.5, "Pune", 850000, 5, 200000, 15, 120.5, "DL12345");
        df.displayDairy();

        PoultryFarmer pf = new PoultryFarmer(102, "Suresh", 8.0, "Nashik", 600000, 3, 150000, 500, 4, 400, 600, "Happy Hen Farm");
        pf.displayPoultry();

        OrganicFarmer of = new OrganicFarmer(103, "Mahesh", 12.0, "Satara", 950000, 6, 250000, "ORG5678", "Wheat", "Cow Dung Compost");
        of.displayOrganic();
    }//main ends here
}//farmmain ends here
