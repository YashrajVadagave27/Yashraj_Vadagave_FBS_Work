...
class Car extends Vehicle {
    ...
    Car(String brand, String model, double price, int seats, String fuelType) {
...
class VehicleMain {
    public static void main(String[] args) {
        ...
        Bike b = new Bike("Yamaha", "R15", 180000, "Racing", 155);
        b.display();

        Bus bs = new Bus("Volvo", "9400", 9000000, 50, "Intercity");
        bs.display();
